...
const sampleVideos: VideoWithPlayer[] = [
  {
    ...
    metadata: {
      ...
      description:
        "The exact framework I used to build a $10K business in just 30 days. No fluff, just actionable steps that work.",
    ...
    insights: {
      ...
      script:
        "Today I'm going to share the exact framework that helped me build a $10K business in just 30 days. This isn't theory - this is what actually worked for me and my clients.",
      transcript:
  ...
  },
  {
    ...
    metadata: {
      ...
      description:
        "Understanding the psychology behind viral content and how to apply these principles to your own content strategy.",
    ...
    insights: {
      ...
      script:
        "Today we're diving deep into the psychology of viral content. I've analyzed thousands of viral videos and found the common patterns that make content shareable.",
      transcript:
        "Have you ever wondered why some videos get millions of views while others barely get any engagement? It's not just luck - there's actual psychology behind it. Today I'm going to break down the key psychological principles that make content go viral...",
      analysis: {
        engagementRate: 7.2,
        completionRate: 82,
  ...
  },
  {
    ...
    metadata: {
      ...
      description:
        "The five morning habits that completely transformed my productivity, health, and overall life satisfaction.",
    ...
    insights: {
      ...
      script:
        "Today I'm sharing the five morning habits that completely changed my life. These aren't just tips - they're game-changers that transformed my entire day.",
      transcript:
        "Good morning everyone! Today I want to share something that completely changed my life. I used to be that person who would hit snooze five times every morning, rush out the door, and feel exhausted by 10 AM. But then I discovered these five morning habits that literally transformed everything...",
      analysis: {
        engagementRate: 9.1,
        completionRate: 85,
    ...
    <div className="bg-background min-h-screen p-6">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 text-center">
          <h1 className="mb-2 text-3xl font-bold">Video Insights Modal Test</h1>
        ...
        <div className="bg-card border-border mb-6 rounded-lg border p-6">
          <div className="flex items-start gap-4">
            {/* Video Thumbnail */}
            <div className="relative h-48 w-32 flex-shrink-0 overflow-hidden rounded-lg bg-black">
            ...
            <div className="flex-1">
              <h2 className="mb-2 text-lg font-semibold">{currentVideo.title}</h2>
              <p className="text-muted-foreground mb-3 text-sm">by @{currentVideo.metadata?.author}</p>
              ...
              <p className="text-muted-foreground line-clamp-2 text-sm">{currentVideo.metadata?.description}</p>
            </div>
          </div>
        </div>
