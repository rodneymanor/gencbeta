...
import { Download, Save, Mic, RefreshCw, Sparkles, FileText } from "lucide-react";
...
export function EditorToolbar({ script, onSave }: EditorToolbarProps) {
  ...
  return (
    <div className="border-border/50 bg-background border-b px-6 py-3">
      <div className="flex items-center justify-between">
        {/* Left side - Editor title */}
        <div className="flex items-center gap-2">
          <FileText className="text-primary h-5 w-5" />
          <span className="text-lg font-medium">Script Editor</span>
        </div>
