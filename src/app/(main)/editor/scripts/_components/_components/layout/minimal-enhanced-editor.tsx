    ...
    <div className="min-h-screen bg-background" style={editorStyles}>
      ...
      {contextMenuPosition && selectedElement && (
        <ContextualMenu
          ...
          onAnalyze={(element) => console.log('Analyze:', element)}
          onEnhance={(element) => console.log('Enhance:', element)}
          onGenerateAlternatives={(element) => console.log('Alternatives:', element)}
        />
      )}
    </div>
  );
