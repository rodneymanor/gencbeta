...
const meta: Meta<typeof CreatorSpotlightPage> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A comprehensive page for discovering and analyzing creators from TikTok and Instagram. Features a grid view of creator profiles and detailed views with their videos.",
      },
    },
  },
  tags: ["autodocs"],
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The default Creator Spotlight page showing a grid of creator profiles with search and filter functionality.",
      },
    },
  },
};
