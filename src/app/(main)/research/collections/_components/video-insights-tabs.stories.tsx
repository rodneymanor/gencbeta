...
const mockVideoData = {
  ...
  transcript:
    "This is a sample transcript of the video content. It contains the full text of what was said in the video, including all the important points and key messages that were communicated to the audience.",
  components: {
  ...
  visualContext:
    "The video shows a person speaking directly to the camera in a well-lit environment with engaging visuals in the background.",
  insights: {
    likes: 15420,
    comments: 892,
    shares: 1234,
