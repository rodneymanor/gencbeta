...
export function AccountBadge() {
  ...
  if (initializing || !user) {
    return (
      <div className="focus:ring-ring text-foreground flex items-center gap-1 rounded-lg border bg-white px-2.5 py-0.5 text-xs font-semibold opacity-60 transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none">
