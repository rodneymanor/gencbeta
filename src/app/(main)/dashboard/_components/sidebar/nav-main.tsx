          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SpeedWriteDialog>
                <SidebarMenuButton
                  tooltip="Speed Write"
                  className="bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:text-secondary-foreground active:bg-secondary/80 active:text-secondary-foreground flex h-8 min-w-8 items-center justify-center duration-200 ease-linear group-data-[collapsible=icon]:h-8 group-data-[collapsible=icon]:w-8 group-data-[collapsible=icon]:p-0"
                >
