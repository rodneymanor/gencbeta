        ...
        <div className="space-y-4">
          <div className="relative">
            <Textarea
              ...
              className="bg-background dark:bg-background text-foreground dark:text-foreground placeholder:text-muted-foreground dark:placeholder:text-muted-foreground border-border/50 dark:border-border/50 ring-border/50 dark:ring-border/50 focus:ring-primary/70 dark:focus:ring-primary/70 focus:shadow-primary/10 caret-primary selection:bg-primary/30 selection:text-foreground scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent block max-h-[45vh] min-h-[160px] w-full resize-none appearance-none rounded-2xl border px-4 py-3 pr-16 text-base leading-6 shadow-sm transition-colors transition-shadow duration-150 hover:shadow-md focus:shadow-lg focus:ring-2 focus:ring-offset-0 focus-visible:outline-none sm:max-h-[25vh] lg:max-h-[40vh]"
              disabled={disabled}
              style={{
        ...
        <div className="space-y-4">
          <div className="relative">
            <Input
              ...
              onKeyDown={handleKeyDown}
              className="bg-background dark:bg-background text-foreground dark:text-foreground placeholder:text-muted-foreground dark:placeholder:text-muted-foreground border-border/50 dark:border-border/50 ring-border/50 dark:ring-border/50 focus:ring-primary/70 dark:focus:ring-primary/70 focus:shadow-primary/10 caret-primary selection:bg-primary/30 selection:text-foreground block h-14 w-full appearance-none rounded-2xl border px-4 py-3 pr-12 text-base leading-6 shadow-sm transition-colors transition-shadow duration-150 hover:shadow-md focus:shadow-lg focus:ring-2 focus:ring-offset-0 focus-visible:outline-none"
              disabled={disabled}
              style={{
                fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
              }}
