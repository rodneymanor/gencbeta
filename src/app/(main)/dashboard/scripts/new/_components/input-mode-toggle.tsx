        ...
        <div className="space-y-4">
          <div className="relative">
            <Textarea
              ...
              className="bg-background dark:bg-background text-foreground dark:text-foreground placeholder:text-muted-foreground dark:placeholder:text-muted-foreground border-border/50 dark:border-border/50 ring-border/50 dark:ring-border/50 focus:ring-primary/70 dark:focus:ring-primary/70 caret-primary selection:bg-primary/30 selection:text-foreground scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent block max-h-[45vh] min-h-[160px] w-full resize-none appearance-none rounded-2xl border px-4 py-3 pr-16 text-base leading-6 shadow-[0_1px_8px_2px_oklch(var(--text-color-100)/0.1),0_36px_16px_36px_oklch(var(--background-color-100))] transition-colors transition-shadow duration-150 hover:shadow-[0_2px_12px_3px_oklch(var(--text-color-100)/0.15),0_40px_20px_40px_oklch(var(--background-color-100))] focus:shadow-[0_0_0_4px_oklch(var(--text-color-100)/0.18),0_36px_16px_36px_oklch(var(--background-color-100))] focus:ring-2 focus:ring-offset-0 focus-visible:outline-none sm:max-h-[25vh] lg:max-h-[40vh] dark:shadow-[0_4px_12px_rgba(0,0,0,0.12),0_32px_16px_36px_oklch(var(--background-color-100))] dark:hover:shadow-[0_6px_16px_rgba(0,0,0,0.16),0_40px_20px_40px_oklch(var(--background-color-100))] dark:focus:shadow-[0_0_0_4px_rgba(255,255,255,0.10),0_32px_16px_36px_oklch(var(--background-color-100))]"
              disabled={disabled}
              style={{
