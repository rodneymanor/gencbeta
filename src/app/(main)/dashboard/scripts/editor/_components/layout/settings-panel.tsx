            ...
            {activeSection === 'readability' && (
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs text-green-600">Easy Threshold: {settings.readability.thresholds.easy}</Label>
                    <Slider
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs text-yellow-600">Medium Threshold: {settings.readability.thresholds.medium}</Label>
                    <Slider
