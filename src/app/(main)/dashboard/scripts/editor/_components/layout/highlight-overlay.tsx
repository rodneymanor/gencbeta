...
export function HighlightOverlay({ text, highlightSettings, onElementAction }: HighlightOverlayProps) {
  ...
  // Analyze readability
  const readabilityResult = useMemo(() => analyzeReadabilityHighlighting(text), [text]);
  ...
  // Generate highlighted HTML
  const highlightedHTML = useMemo(() => generateHighlightedHTML(text, combinedHighlights), [text, combinedHighlights]);
  ...
  return (
    <div className="relative">
      ...
      <div
        className="pointer-events-none absolute inset-0 overflow-hidden p-4 font-mono text-sm leading-relaxed break-words whitespace-pre-wrap"
        style={{
          color: "transparent",
          zIndex: 1,
        }}
      ...
      <div
        className="pointer-events-auto absolute inset-0 overflow-hidden p-4 font-mono text-sm leading-relaxed break-words whitespace-pre-wrap"
        style={{
          color: "transparent",
          zIndex: 2,
        }}
        dangerouslySetInnerHTML={{
          __html: highlightedHTML.replace(/class="readability-highlight[^"]*"/g, 'class="pointer-events-none"'),
        }}
      />
