...
export function AdvancedHighlightControls({ 
  settings, 
  onSettingsChange, 
  scriptStats 
}: AdvancedHighlightControlsProps) {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {/* Master Controls */}
        <Collapsible 
          open={expandedSections.has('global')} 
        ...
        <Collapsible 
          open={expandedSections.has('elements')} 
              ...
              return (
                <div key={key} className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <Switch
                      checked={isEnabled}
                      onCheckedChange={() => toggleElement(key as keyof HighlightSettings)}
                    />
                  </div>
                    ...
                    <div className="pl-6 space-y-3 border-l-2 border-muted">
                      <div className="space-y-2">
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) => 
                            updateSetting(`elementSettings.${key}.opacity`, value)
                          }
                          max={100}
                          min={10}
                          step={5}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) => 
                            updateSetting(`elementSettings.${key}.showLabels`, checked)
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) => 
                            updateSetting(`elementSettings.${key}.animateOnHover`, checked)
                          }
                        />
                      </div>
                    </div>
        ...
        <Collapsible 
          open={expandedSections.has('readability')} 
          onOpenChange={() => toggleSection('readability')}
        >
          <CollapsibleTrigger asChild>
            <Button variant="ghost" className="w-full justify-between p-2 h-auto">
              <div className="flex items-center gap-2">
          ...
          <CollapsibleContent className="space-y-3 pt-2">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={() => toggleElement('readability')}
              />
            </div>
              ...
              <div className="space-y-3 pl-4 border-l-2 border-muted">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => 
                      updateSetting('readabilitySettings.showGradient', checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => 
                      updateSetting('readabilitySettings.showTooltips', checked)
                    }
                  />
                </div>
              </div>
        ...
        <div className="flex gap-2 pt-2 border-t">
          <Button
            ...
            onClick={() => {
              // Toggle all elements
              const allEnabled = Object.keys(elementConfig).every(
                key => settings[key as keyof HighlightSettings]
              );
