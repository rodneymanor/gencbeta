export const TEMPLATE_GENERATION_PROMPTS = {
  /**
   * Prompt for converting a specific marketing segment into a generic template
   */
  createTemplateFromComponent: (componentText: string, componentType: string) => `
...
Expected JSON format:
{
   ...
   */
  analyzeTranscription: (transcription: string) => `
