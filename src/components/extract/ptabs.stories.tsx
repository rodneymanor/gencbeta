    ...
    items: [
      {
        ...
        description: 'This is a very long description that contains a lot of text to test how the component handles overflow and text wrapping in different scenarios. It should gracefully handle this content.',
        icon: '📝',
